...
public class Tests implements BeforeAllCallback, AfterAllCallback {
  ...
  public static final Orchestrator ORCHESTRATOR = OrchestratorExtension.builderEnv()
    ...
    // The following plugin versions are hardcoded because `DEV` is not compatible with SQ < 0.9, to be fixed with this issue: https://github.com/SonarSource/sonar-scanner-msbuild/issues/1486
    .addPlugin(TestUtils.getMavenLocation("org.sonarsource.javascript", "sonar-javascript-plugin", System.getProperty("sonar.javascriptplugin.version", "7.16.0.30901")))
    .addPlugin(TestUtils.getMavenLocation("com.sonarsource.plsql", "sonar-plsql-plugin", System.getProperty("sonar.plsqlplugin.version", "3.8.0.4948")))
    .activateLicense()
    .build();
