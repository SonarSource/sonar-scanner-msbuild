...
public enum ScannerClassifier {
  NET("net", "dotnet", Path.of("../Packaging/net/SonarScanner.MSBuild.dll").toAbsolutePath().toString()),
  NET_FRAMEWORK("net-framework", Path.of("../Packaging/net-framework/SonarScanner.MSBuild.exe").toAbsolutePath().toString(), null);
