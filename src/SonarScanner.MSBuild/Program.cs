        ...
        if (ArgumentProcessor.IsHelp(args))
        {
            runtime.LogInfo("""
                ...
                Usage on SonarQube Cloud:
                  ...
                  - The authentication token should be provided through 'sonar.token' parameter on SonarQube Server or 'sonar.login' on SonarQube Cloud in both 'BEGIN' and 'END' steps.
                ...
                Useful links:
                  - Available properties for SonarQube Server: https://docs.sonarqube.org/latest/analysis/scan/sonarscanner-for-msbuild/
                  ...
                  - Generate a token for analysis on SonarQube Server: https://docs.sonarqube.org/latest/user-guide/user-token/
