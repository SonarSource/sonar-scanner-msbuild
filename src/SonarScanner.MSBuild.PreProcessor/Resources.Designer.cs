...
namespace SonarScanner.MSBuild.PreProcessor {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Failed to import the {0} file {1}: {2}.
        /// </summary>
        internal static string ERROR_CertificateImportFailed {
            get {
                return ResourceManager.GetString("ERROR_CertificateImportFailed", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The argument &apos;sonar.scanner.engineJarPath&apos; contains an invalid path. Please make sure the path is correctly pointing to the scanner engine jar..
        /// </summary>
        internal static string ERROR_InvalidEngineJarPath {
            get {
                return ResourceManager.GetString("ERROR_InvalidEngineJarPath", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Cache miss. Could not find &apos;{0}&apos;..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Fall back on using the truststore from the default location at {0}..
        /// </summary>
        internal static string MSG_FallbackTruststoreDefaultPath {
            get {
                return ResourceManager.GetString("MSG_FallbackTruststoreDefaultPath", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to No truststore found at the default location; proceeding without a truststore..
        /// </summary>
        internal static string MSG_NoTruststoreProceedWithoutTruststore {
            get {
                return ResourceManager.GetString("MSG_NoTruststoreProceedWithoutTruststore", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to No truststore provided; attempting to use the default location..
        /// </summary>
        internal static string MSG_NoTruststoreProvideTryDefault {
            get {
                return ResourceManager.GetString("MSG_NoTruststoreProvideTryDefault", resourceCulture);
            }
        }
