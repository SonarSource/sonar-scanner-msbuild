...
namespace SonarScanner.MSBuild.PreProcessor.CliResolution;
    ...
    private async Task<string> DownloadScannerCli(ArchiveDownloader archiveDownloader)
    {
        switch (await archiveDownloader.DownloadAsync(() => httpClient.GetStreamAsync(ScannerCliUri)))
        {
            case CacheHit cacheHit:
                ...
                // runtime.Telemetry[TelemetryKeys.JreDownload] = TelemetryValues.JreDownload.CacheHit; TODO add telemetry
            ...
            case Downloaded downloaded:
                ...
                // runtime.Telemetry[TelemetryKeys.JreDownload] = TelemetryValues.JreDownload.Downloaded;   TODO add telemetry
                return downloaded.FilePath;
            case DownloadError error:
                runtime.LogDebug(Resources.MSG_Resolver_DownloadFailure, nameof(ScannerCliResolver), error.Message);
                // runtime.Telemetry[TelemetryKeys.JreDownload] = TelemetryValues.JreDownload.Failed;   TODO add telemetry
                return null;
            default:
