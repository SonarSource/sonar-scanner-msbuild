...
public class Runtime : IRuntime
{
    ...
    public IAnalysisWarnings AnalysisWarnings { get; }

    public Runtime(OperatingSystemProvider operatingSystem, IDirectoryWrapper directoryWrapper, IFileWrapper fileWrapper, ILogger logger, ITelemetry telemetry, IAnalysisWarnings analysisWarnings)
    {
