...
namespace SonarQube.Bootstrapper {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The C# plugin you have installed on the server is not compatible with the SonarQube.MSBuild.Runner.exe - either check the compatibility matrix or get the latest versions for both. .
        /// </summary>
