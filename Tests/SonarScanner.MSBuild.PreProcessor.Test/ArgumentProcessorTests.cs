...
public class ArgumentProcessorTests
{
    ...
    public void PreArgProc_NoArguments_ProcessingFails()
    {
        ...
        runtime.Should().HaveSingleErrorLogged("/key:"); // we expect error with info about the missing required parameter, which should include the primary alias
    ...
    public void PreArgProc_KeyHasNoValue_ProcessingFails()
    {
        ...
        runtime.Should().HaveSingleErrorLogged("/key:");
        runtime.Should().HaveErrorsLogged(1);
    }
    ...
    public void PreArgProc_ApiBaseUrl_Set()
    {
        ...
        runtime.Should().HaveDebugsLogged("Server Url: https://sonarcloud.io");
        runtime.Should().HaveDebugsLogged("Api Url: test");
        runtime.Should().HaveDebugsLogged("Is SonarCloud: True");
    }
    ...
    public void PreArgProc_ApiBaseUrl_NotSet_SonarCloudDefault(string sonarcloudUrl)
    {
        ...
        runtime.Should().HaveDebugsLogged($"Server Url: {sonarcloudUrl}");
        runtime.Should().HaveDebugsLogged("Api Url: https://api.sonarcloud.io");
        runtime.Should().HaveDebugsLogged("Is SonarCloud: True");
    }
    ...
    public void PreArgProc_ApiBaseUrl_NotSet_SonarQubeDefault(string hostUri, string expectedApiUri)
    {
        ...
        runtime.Should().HaveDebugsLogged($"Server Url: {hostUri}");
        runtime.Should().HaveDebugsLogged($"Api Url: {expectedApiUri}");
        runtime.Should().HaveDebugsLogged("Is SonarCloud: False");
    }
    ...
    public void PreArgProc_Region_US(string region)
    {
        ...
        runtime.Should().HaveDebugsLogged("Server Url: https://sonarqube.us");
        runtime.Should().HaveDebugsLogged("Api Url: https://api.sonarqube.us");
        runtime.Should().HaveDebugsLogged("Is SonarCloud: True");
    }
                                            ...
                                            params string[] expectedWarnings)
    {
        ...
        runtime.Should().HaveDebugsLogged($"Server Url: {expectedHostUri}");
        runtime.Should().HaveDebugsLogged($"Api Url: {expectedApiUri}");
        runtime.Should().HaveDebugsLogged($"Is SonarCloud: {args.ServerInfo.IsSonarCloud}");
    ...
    public void PreArgProc_UnrecognisedArguments(params string[] args)
    {
        ...
        runtime.Should().NotHaveErrorLogged("/name:");
        ...
        {
            runtime.Should().HaveSingleErrorLogged(arg);
        }
    ...
    public void ArgProc_InstallTargets_Invalid(string installValue)
    {
        ...
        runtime.Should().HaveErrorsLogged(1);
        runtime.Should().HaveSingleErrorLogged("/install");
    }
    ...
    public void PreArgProc_PropertiesFileSpecifiedOnCommandLine_DoesNotExist()
    {
        ...
        runtime.Should().HaveErrorsLogged(1);
        runtime.Should().HaveSingleErrorLogged("Unable to find the analysis settings file", "Please fix the path to this settings file.");
    }
    ...
    public void PreArgProc_With_PropertiesFileSpecifiedOnCommandLine_Organization_Set_Only_In_It_Should_Fail()
    {
        ...
        runtime.Should().HaveErrorsLogged(1);
        runtime.Should().HaveSingleErrorLogged("sonar.organization parameter has been detected in the provided SonarQube.Analysis.xml config file. Please pass it in the command line instead, using /o: flag");
    }
    ...
    public void PreArgProc_Aliases_Invalid()
    {
        ...
        runtime.Should().HaveSingleErrorLogged("/KEY:my.key");
        runtime.Should().HaveSingleErrorLogged("/nAme:my name");
        runtime.Should().HaveSingleErrorLogged("/versIOn:1.0");
    }
    ...
    public void PreArgProc_MultipleDuplicates_ProcessingFails()
    {
        ...
        runtime.Should().HaveSingleErrorLogged("/k:k2", "my.key"); // Warning about key appears twice
        runtime.Should().HaveSingleErrorLogged("/k:key3", "my.key");
        runtime.Should().HaveErrorsLogged(2);
    }
    ...
    public void PreArgProc_DynamicSettings_Invalid()
    {
        ...
        runtime.Should().HaveSingleErrorLogged("invalid1 =aaa");
        runtime.Should().HaveSingleErrorLogged("notkeyvalue");
        runtime.Should().HaveSingleErrorLogged(" spacebeforekey=bb");
        runtime.Should().HaveSingleErrorLogged("missingvalue=");
        runtime.Should().HaveErrorsLogged(4);
    }
    ...
    public void PreArgProc_DynamicSettings_Duplicates()
    {
        ...
        runtime.Should().HaveSingleErrorLogged("dup1=value2", "value1");
        runtime.Should().HaveSingleErrorLogged("dup2=value4", "value3");
        runtime.Should().HaveErrorsLogged(2);
    }
    ...
    public void PreArgProc_Arguments_Duplicates_WithDifferentFlagsPrefixes()
    {
        ...
        runtime.Should().HaveErrorsLogged(3);
        runtime.Should().HaveSingleErrorLogged("dup1=value2", "value1");
        runtime.Should().HaveSingleErrorLogged("dup2=value4", "value3");
        runtime.Should().HaveSingleErrorLogged("version:1.2", "1.2");
    }
