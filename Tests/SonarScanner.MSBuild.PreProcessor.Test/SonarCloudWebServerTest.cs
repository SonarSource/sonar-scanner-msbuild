...
public class SonarCloudWebServerTest
{
    ...
    public async Task DownloadCache_RequestUrl(string cacheBaseUrl, string cacheFullUrl)
    {
        ...
        context.Logger.Should().HaveSingleInfo($"Incremental PR Analysis: Requesting 'prepare_read' from {cacheFullUrl}");
        handler.Requests.Should().NotBeEmpty();
    }
    ...
    public async Task DownloadCache_PrepareRead_UnsuccessfulResponse()
    {
        ...
        result.Should().BeEmpty();
        context.Logger.Should().HaveSingleInfo("Incremental PR analysis: an error occurred while retrieving the cache entries! 'prepare_read' did not respond successfully.");
        handler.Requests.Should().NotBeEmpty();
    }
    ...
    public async Task DownloadCache_PrepareRead_EmptyResponse()
    {
        ...
        result.Should().BeEmpty();
        context.Logger.Should().HaveSingleInfo("Incremental PR analysis: an error occurred while retrieving the cache entries! 'prepare_read' response was empty.");
        handler.Requests.Should().NotBeEmpty();
    }
    ...
    public async Task DownloadCache_PrepareRead_CacheDisabled()
    {
        ...
        result.Should().BeEmpty();
        context.Logger.Should().HaveSingleInfo(
    ...
    public async Task DownloadCache_PrepareRead_CacheEnabledButUrlMissing()
    {
        ...
        result.Should().BeEmpty();
        context.Logger.Should().HaveSingleInfo("Incremental PR analysis: an error occurred while retrieving the cache entries! 'prepare_read' response: { Enabled = True, Url =  }");
        handler.Requests.Should().NotBeEmpty();
    }
