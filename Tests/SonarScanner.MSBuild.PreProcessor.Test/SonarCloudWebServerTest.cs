...
public class SonarCloudWebServerTest
{
    ...
    {
        sut = new SonarCloudWebServer(downloader, downloader, new Version("0.0.1"), logger, Organization, httpTimeout);
    ...
    public void DownloadProperties_Success()
    {
        ...
        sut = CreateServer(downloaderMock);
    ...
    public async Task DownloadRules_SonarCloud()
    {
        ...
        sut = CreateServer(testDownloader);
