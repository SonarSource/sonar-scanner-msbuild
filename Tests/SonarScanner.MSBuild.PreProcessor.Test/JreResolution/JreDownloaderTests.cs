...
public class JreDownloaderTests
{
    ...
    public async Task EndToEndTestWithFiles_Zip_Success()
    {
        ...
        try
        {
            var result = await sut.DownloadFileAsync(jreDescriptor, () => Task.FromResult<Stream>(new MemoryStream(zipContent)));
    ...
    public async Task EndToEndTestWithFiles_TarGz_Success()
    {
        ...
        try
        {
            var result = await sut.DownloadFileAsync(jreDescriptor, () => Task.FromResult<Stream>(new MemoryStream(tarContent)));
