...
namespace SonarScanner.MSBuild.Common.Test
{
    ...
    public class AnalyzerSettingsTests
    {
        ...
        {
            // Arrange
            Action action = () => new AnalyzerSettings("language", null,"globalAnalyzerPath", "path", "path", Enumerable.Empty<AnalyzerPlugin>(), Enumerable.Empty<string>());
        ...
        {
            // Arrange
            Action action = () => new AnalyzerSettings("language", "path", "globalAnalyzerPath", "path", null, Enumerable.Empty<AnalyzerPlugin>(), Enumerable.Empty<string>());
        ...
        {
            // Arrange
            Action action = () => new AnalyzerSettings("language", "", "globalAnalyzerPath", "path", "path", Enumerable.Empty<AnalyzerPlugin>(), Enumerable.Empty<string>());
        ...
        {
            // Arrange
            Action action = () => new AnalyzerSettings("language", "foo", "globalAnalyzerPath", "path", "path", null, Enumerable.Empty<string>());
        ...
        {
            // Arrange
            Action action = () => new AnalyzerSettings("language", "foo", "globalAnalyzerPath", "path", "path", Enumerable.Empty<AnalyzerPlugin>(), null);
