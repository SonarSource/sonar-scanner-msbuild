...
public class ArgumentProcessorTests
{
    ...
    public void ArgProc_InvalidCmdLineProperties()
    {
        ...
        logger.Should().HaveSingleError(" key1");
        logger.Should().HaveSingleError("key2 ");
    }
    ...
    public void ArgProc_BeginVerb()
    {
        ...
        logger.Should().HaveSingleError(ArgumentProcessor.BeginVerb);
    ...
    public void ArgProc_BeginAndEndVerbs()
    {
        ...
        logger.Should().HaveSingleError("begin", "end");
    }
    ...
    public void ArgProc_SonarVerbose_IsBool()
    {
        ...
        logger.Should().HaveSingleWarning("yes");
    }
