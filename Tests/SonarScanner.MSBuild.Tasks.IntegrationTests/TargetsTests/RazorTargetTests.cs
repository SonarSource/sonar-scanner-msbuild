...
";
            ...
            var filePath = CreateProjectFile(null, projectDirectory, projectSnippet);
        ...
        private string CreateProjectFile(AnalysisConfig config, string projectDirectory, string projectSnippet)
        {
            var targetTestUtils = new TargetsTestsUtils(TestContext);
