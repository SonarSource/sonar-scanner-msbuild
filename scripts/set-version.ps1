...
try {
    ...
    If ($BuildNumber -eq 0) {
        ...
        dotnet restore SonarScanner.MSBuild.sln --force-evaluate
        ...
        gh pr create --title "Bump version to $ShortVersion" --body "kljj" --web --base master --head "version-bump/$ShortVersion"
    }
